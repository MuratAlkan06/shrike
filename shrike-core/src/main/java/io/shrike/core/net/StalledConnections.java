 ...
 * {@code read.timeout.ms}, as of one epoch millisecond.
 *
...
interface StalledConnections {
    ...
    /**
     * @param nowMillis the epoch millisecond every read phase's age is measured against, which is where
     *                  the injected clock enters
     */
    void closeStalledConnections(long nowMillis);
}
